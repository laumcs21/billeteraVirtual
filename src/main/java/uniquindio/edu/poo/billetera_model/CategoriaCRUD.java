package uniquindio.edu.poo.billetera_model;
    ...
    public class CategoriaCRUD implements CRUD<Categoria>, Serializable{
        ...
        public Categoria crear(Categoria categoria) {
            ...
            billetera.getCategorias().add(categoria);
            persistencia.guardarTodasLasCategorias(billetera.getCategorias());
            persistencia.guardarCategoriaEnXML(categoria);
            persistencia.guardarCategoriaBinario(categoria);
